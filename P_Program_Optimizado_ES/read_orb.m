%%
%% Lee el fichero label.ORB_INDX y rellena las sub-estructuras de orbitales
%% (índices, números cuánticos, especie, zeta, ...).
%%
...
%% Lee la primera línea y extrae nos y nou
...
%% Lee la información de cada orbital
for i = 1:nos
