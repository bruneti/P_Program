%%
%% Calcula las bandas de Kohn-Sham a lo largo de las líneas entre cada dos
%% k-points consecutivos.
%%
%% La energía de referencia es EF
%%
...
k = 2*pi*k;
post.k=k;
%% Bandas a lo largo de la línea solicitada
for ik = 1:size(k,1)
