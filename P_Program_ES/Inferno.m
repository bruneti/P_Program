...
CL=Full_CL; % necesario para JiLM.
% JiLM(CL,il,l1,l2,l3,m1,m2,m3), como recordamos
tic
for il=-1:1
    for l1=0:3
        for l2=0:3
...
% Tabulamos todos los resultados posibles de JiLM en un tensor 7D, para acelerar los cálculos.