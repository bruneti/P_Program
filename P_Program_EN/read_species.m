%%
%% This function finds in the main siesta output file 'logfile'
%% the relevant species info and retrieves it in the sub-structures:
%%
%%
%% Written by J. Ferrer, October 2020, January 2022
%%
...
%% Find number of species and siesta''s internal species code number
...
%% Read PAO data for each species
...
%% Dump everything inside the cell siesta.species
