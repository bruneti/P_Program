%Tabulation of the Real spherical harmonic.
...
if abs(m)>abs(l)
    fprintf('l or m badly chosen')
end
if l<0
    fprintf('l badly chosen')
end
if l>7
    fprintf('This value is not tabulated')
end
if l==0 
   if m==0
       Yrml=1/2*sqrt(1/pi);
