%%
%% This subroutine find SIESTA''s structural data.
%%
%% Output data are the sub-structure 'Lattice.' that contains:
%%
%%
%% Written by J. Ferrer, 2020
%%
...
%% Read file 'label.STRUCT_OUT' and split it by lines
file  = fileread(fstr);
split = strsplit(file,'\n');
...
if contains(logfile,'Internal auxiliary supercell:');
  ...
  if (rem([N1 N2 N3],2) == 0), 
	disp('Number of unit cells in SIESTA is wrong');
	stop
  end
